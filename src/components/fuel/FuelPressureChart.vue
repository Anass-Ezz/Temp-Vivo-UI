...
<script setup>
/**
 * @component FuelPressureChart
 * @description UI Component for FuelPressureChart.
 *
...
async function fetchData() {
  ...
  try {
    ...
    // Use queryHistoricTimeseriesData for fuel pressure data
    ...
    console.error('Error fetching fuel pressure data:', error)
    loading.value = false
  }
}
