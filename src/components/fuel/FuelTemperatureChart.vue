...
<script setup>
/**
 * @component FuelTemperatureChart
 * @description UI Component for FuelTemperatureChart.
 *
...
async function fetchData() {
  ...
  try {
    ...
    // Use queryHistoricTimeseriesData for fuel temperature data
    ...
    console.error('Error fetching fuel temperature data:', error)
    loading.value = false
  }
}
